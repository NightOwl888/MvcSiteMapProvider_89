...
using MvcSiteMapProvider_89.DI.StructureMap.Conventions;

namespace MvcSiteMapProvider_89.DI.StructureMap.Registries
{
        ...
        : Registry
    {
        public MvcSiteMapProviderRegistry()
        {
            ...
            string[] includeAssembliesForScan = new string[] { "MvcSiteMapProvider_89" };
...
// Visibility Providers
            this.For<ISiteMapNodeVisibilityProviderStrategy>().Use<SiteMapNodeVisibilityProviderStrategy>()
                .Ctor<string>("defaultProviderName").Is("MvcSiteMapProvider.TrimEmptyGroupingNodesVisibilityProvider, MvcSiteMapProvider");
